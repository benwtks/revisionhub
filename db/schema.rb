...
ActiveRecord::Schema.define(version: 20170802151425) do
  ...
  create_table "subjects_subject_tags", id: false, force: :cascade do |t|
    t.integer  "subject_id"
    t.integer  "subject_tag_id"
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["subject_id"], name: "index_subjects_subject_tags_on_subject_id", using: :btree
    t.index ["subject_tag_id"], name: "index_subjects_subject_tags_on_subject_tag_id", using: :btree
  end
